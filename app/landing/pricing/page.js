...
const SCAN_TABLES = [
  {
    ...
    features: [
      { label: 'HTTPS & HSTS enforcement', free: true, starter: true, pro: true },
      { label: 'Content-Security-Policy analysis', free: true, starter: true, pro: true },
      { label: 'SSL certificate health', free: true, starter: true, pro: true },
      { label: 'Cookie hardening checks', free: true, starter: true, pro: true },
      { label: 'Cross-origin & clickjacking checks', free: true, starter: true, pro: true },
      { label: 'Information disclosure detection', free: true, starter: true, pro: true },
      { label: 'Exposed API keys & tokens', free: true, starter: true, pro: true },
      { label: 'Exposed files & repositories', free: true, starter: true, pro: true },
      { label: 'Source map exposure', free: true, starter: true, pro: true },
      { label: 'Known-vulnerable JS libraries (CVEs)', free: true, starter: true, pro: true },
      { label: 'SPF & DMARC strength', free: true, starter: true, pro: true },
      { label: 'Subdomain enumeration & takeover', free: true, starter: true, pro: true },
      { label: 'Malware / phishing blocklist', free: true, starter: true, pro: true },
      { label: 'Severity-ranked findings (5 levels)', free: true, starter: true, pro: true },
      { label: 'AI-ready fix prompt per finding', free: true, starter: true, pro: true },
      { label: 'Streaming AI security analysis', free: false, starter: true, pro: true },
      { label: 'Attack-chain threat modeling', free: false, starter: false, pro: true },
      { label: 'OWASP Top 10 mapping', free: false, starter: false, pro: true },
      { label: 'GDPR / PCI compliance readiness', free: false, starter: false, pro: true },
    ],
  },
  {
    key: 'seo',
    ...
    features: [
      { label: 'HTTPS enforcement', free: true, starter: true, pro: true },
      { label: 'robots.txt & XML sitemap', free: true, starter: true, pro: true },
      { label: 'Canonical URLs & meta robots', free: true, starter: true, pro: true },
      { label: 'Mobile friendliness & viewport', free: true, starter: true, pro: true },
      { label: 'Title tag & meta description', free: true, starter: true, pro: true },
      { label: 'H1 hierarchy & keyword alignment', free: true, starter: true, pro: true },
      { label: 'Image alt text checks', free: true, starter: true, pro: true },
      { label: 'Schema.org JSON-LD detection', free: true, starter: true, pro: true },
      { label: 'Open Graph & Twitter Card tags', free: true, starter: true, pro: true },
      { label: 'Broken internal links', free: true, starter: true, pro: true },
      { label: 'SERP preview', free: false, starter: true, pro: true },
      { label: 'Core Web Vitals (LCP, CLS, FCP)', free: false, starter: false, pro: true },
      { label: 'Redirect chains detection', free: false, starter: false, pro: true },
      { label: 'Local SEO NAP consistency', free: false, starter: false, pro: true },
      { label: 'Multi-page crawl', free: false, starter: false, pro: true },
      { label: 'AI deep analysis (titles, keywords, E-E-A-T)', free: false, starter: false, pro: true },
      { label: 'Competitor SEO comparison', free: false, starter: false, pro: true },
    ],
  },
  {
    key: 'aeo',
    ...
    features: [
      { label: 'GPTBot (ChatGPT) crawler access', free: true, starter: true, pro: true },
      { label: 'ClaudeBot & PerplexityBot access', free: true, starter: true, pro: true },
      { label: 'Google-Extended & Googlebot access', free: true, starter: true, pro: true },
      { label: 'llms.txt & ai.txt presence', free: true, starter: true, pro: true },
      { label: 'Q&A formatting & direct answers', free: true, starter: true, pro: true },
      { label: 'FAQ & HowTo schema validation', free: true, starter: true, pro: true },
      { label: 'Author & freshness signals', free: true, starter: true, pro: true },
      { label: 'Bytespider, CCBot, Applebot coverage', free: false, starter: true, pro: true },
      { label: 'Answer box formatting score', free: false, starter: true, pro: true },
      { label: 'Code examples & snippets check', free: false, starter: true, pro: true },
      { label: 'Internal link context analysis', free: false, starter: true, pro: true },
      { label: 'JavaScript rendering dependency', free: false, starter: false, pro: true },
      { label: 'Structured data completeness', free: false, starter: false, pro: true },
      { label: 'AI answer preview simulation', free: false, starter: false, pro: true },
      { label: 'Competitor AEO comparison', free: false, starter: false, pro: true },
      { label: 'Answer-engine simulation (Pro AI)', free: false, starter: false, pro: true },
      { label: 'Question-coverage gap analysis', free: false, starter: false, pro: true },
    ],
  },
  {
    key: 'geo',
    ...
    features: [
      { label: 'Author bylines & bios', free: true, starter: true, pro: true },
      { label: 'Knowledge Graph entity signals', free: true, starter: true, pro: true },
      { label: 'Contact & trust signals', free: true, starter: true, pro: true },
      { label: 'Content depth (word count)', free: true, starter: true, pro: true },
      { label: 'FAQ schema & sections', free: true, starter: true, pro: true },
      { label: 'Definition format detection', free: true, starter: true, pro: true },
      { label: 'External citations & authority links', free: true, starter: true, pro: true },
      { label: 'Paragraph chunking & readability', free: true, starter: true, pro: true },
      { label: 'Content uniqueness indicators', free: false, starter: true, pro: true },
      { label: 'Statistic freshness', free: false, starter: true, pro: true },
      { label: 'Wikipedia-style inline citations', free: false, starter: true, pro: true },
      { label: 'Entity disambiguation score', free: false, starter: false, pro: true },
      { label: 'Topical cluster detection', free: false, starter: false, pro: true },
      { label: 'Comparison & "best of" optimization', free: false, starter: false, pro: true },
      { label: 'Prompt coverage heatmap', free: false, starter: false, pro: true },
      { label: 'Competitor GEO comparison', free: false, starter: false, pro: true },
      { label: 'Citation simulation (Pro AI)', free: false, starter: false, pro: true },
      { label: 'Knowledge Graph gap analysis', free: false, starter: false, pro: true },
      { label: 'Topical-authority depth map', free: false, starter: false, pro: true },
    ],
  },
  {
    key: 'aso',
    ...
    features: [
      { label: 'App title length & keyword presence', free: false, starter: true, pro: true },
      { label: 'Subtitle / short description', free: false, starter: true, pro: true },
      { label: 'Long description quality', free: false, starter: true, pro: true },
      { label: 'App category selection', free: false, starter: true, pro: true },
      { label: 'Content rating accuracy', free: false, starter: true, pro: true },
      { label: 'IAP disclosure check', free: false, starter: true, pro: true },
      { label: 'Last-updated freshness', free: false, starter: true, pro: true },
      { label: 'Keyword stuffing detection', free: false, starter: true, pro: true },
      { label: 'Localization coverage', free: false, starter: true, pro: true },
      { label: 'Icon quality & presence', free: false, starter: true, pro: true },
      { label: 'Screenshot count & dimensions', free: false, starter: true, pro: true },
      { label: 'Feature graphic (Android)', free: false, starter: true, pro: true },
      { label: 'Preview video presence', free: false, starter: true, pro: true },
      { label: 'Average rating score', free: false, starter: true, pro: true },
      { label: 'Review count & recency', free: false, starter: true, pro: true },
      { label: 'Review sentiment signals', free: false, starter: true, pro: true },
      { label: 'Download / install estimate bracket', free: false, starter: true, pro: true },
      { label: 'Category rank signals', free: false, starter: true, pro: true },
      { label: 'Competitor keyword gap', free: false, starter: true, pro: true },
      { label: 'Universal app flag (iOS)', free: false, starter: true, pro: true },
      { label: 'Scan history & trend tracking', free: false, starter: true, pro: true },
    ],
  },
  {
    key: 'brand',
    ...
    features: [
      { label: 'Custom prompt set tracking', free: true, starter: true, pro: true },
      { label: 'ChatGPT live querying', free: true, starter: true, pro: true },
      { label: 'Claude live querying', free: true, starter: true, pro: true },
      { label: 'Perplexity live querying', free: true, starter: true, pro: true },
      { label: 'Gemini live querying', free: true, starter: true, pro: true },
      { label: 'Brand mention detection (yes/no)', free: true, starter: true, pro: true },
      { label: 'Sentiment classification', free: true, starter: true, pro: true },
      { label: 'Response previews', free: true, starter: true, pro: true },
      { label: 'Prompt × engine visibility matrix', free: true, starter: true, pro: true },
      { label: 'AI visibility score (share of voice)', free: true, starter: true, pro: true },
      { label: 'Historical run comparison', free: false, starter: true, pro: true },
    ],
  },
  {
    key: 'health',
    ...
    features: [
      { label: 'Largest Contentful Paint (LCP)', free: true, starter: true, pro: true },
      { label: 'Interaction to Next Paint (INP)', free: true, starter: true, pro: true },
      { label: 'Cumulative Layout Shift (CLS)', free: true, starter: true, pro: true },
      { label: 'First Contentful Paint (FCP)', free: true, starter: true, pro: true },
      { label: 'Color contrast (WCAG 2.2)', free: true, starter: true, pro: true },
      { label: 'Image alt text (accessibility)', free: true, starter: true, pro: true },
      { label: 'Button & link names', free: true, starter: true, pro: true },
      { label: 'Form labels', free: true, starter: true, pro: true },
      { label: 'Heading order', free: true, starter: true, pro: true },
      { label: 'ARIA correctness', free: true, starter: true, pro: true },
      { label: 'Accessibility score (0–100)', free: true, starter: true, pro: true },
      { label: 'Scan history for regression tracking', free: false, starter: true, pro: true },
      { label: 'Scheduled performance monitoring', free: false, starter: false, pro: true },
    ],
  },
];
