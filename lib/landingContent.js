...
export const NAV_PLATFORM = [
  ...
  {
    href: '/landing/features/llms-txt-generator',
    icon: FileText,
    accent: 'text-primary',
    bgSoft: 'bg-primary/10',
    title: 'llms.txt Generator',
    description: 'Create & validate llms.txt for ChatGPT, Claude & Perplexity crawlers',
  },
  {
...
export const FEATURE_PAGES = {
  'security-scanner': {
    ...
    eyebrow: 'Free Website Security Checker',
    h1: 'Free Website Security Checker & Online Vulnerability Scanner',
    sub: 'Check your website security free with our online vulnerability scanner and web risk assessment tool. Enter a URL and Igris Radar runs 90+ automated checks: security headers, TLS certificates, exposed secrets, live CVE detection for JavaScript libraries, Subdomain Radar for DNS takeover risks, and AI-powered remediation plans in seconds.',
    heroBullets: ['90+ checks across 15 security & risk categories', 'Subdomain Radar: enumerates subdomains & checks takeover risks', 'Live CVE detection for JS libraries & AI-ready fix prompts'],
    stats: [
      { value: 90, suffix: '+', label: 'automated security & risk checks per scan' },
      { value: 15, suffix: '', label: 'security categories, from TLS to attack surface' },
    ...
    faqs: [
      { q: 'What is a website security checker?', a: 'A website security checker is an automated web risk assessment tool that scans live web applications for external security risks, OWASP Top 10 vulnerabilities, misconfigured HTTP headers, exposed API secrets, and server data leaks. Igris Radar acts as a complete website security checker and vulnerability scanner with severity-ranked findings and AI remediation steps.' },
      { q: 'What is Subdomain Radar and how does it detect takeover risks?', a: 'Subdomain Radar enumerates your public subdomains from Certificate Transparency (CT) logs and DNS records, then automatically audits each subdomain for takeover risks—such as dangling CNAME records pointing to decommissioned S3 buckets, Heroku apps, or GitHub Pages.' },
    ...
    ctaTitle: 'Check your website security now',
  ...
  'seo-audit': {
    ...
    eyebrow: 'Free Online Technical SEO Audit Tool',
    h1: 'Complete Technical SEO Audit & On-Page Score Checker',
    sub: 'Technical SEO, on-page signals, structured data, link health, and Core Web Vitals in one scan - 30+ checks. See exactly what\'s holding back your search visibility with a free technical SEO audit tool, prioritized fix list, and competitor comparison.',
    ...
    reportPoints: [
      ...
      'Multi-page crawl plus AI deep analysis (Pro): title suggestions, keyword and search-intent mapping, LSI keyword gap analysis, a semantic coverage score, and an E-E-A-T estimate',
    ],
    faqs: [
      ...
      { q: 'What does the AI deep analysis add?', a: 'On the Pro plan, Gemini-powered deep analysis reviews your actual content and returns title suggestions, a meta description strategy, keyword and search-intent analysis, an LSI keyword gap analysis, a semantic coverage score, and an E-E-A-T estimate.' },
    ],
    references: [
  ...
  'aeo-audit': {
    ...
    h1: 'Answer Engine Optimization (AEO) Audit Tool for AI Search',
    sub: 'AEO is the new SEO. When millions ask AI assistants instead of searching, the brands that get cited win. Our AEO audit tool measures whether answer engines like ChatGPT and Perplexity can crawl, parse, and confidently cite your content, then tells you exactly what to fix.',
  ...
  'geo-audit': {
    ...
    h1: 'Generative Engine Optimization (GEO) & AI Citation Audit',
    ...
    stats: [
      ...
      { value: 4, suffix: '', label: 'AI intelligence features on the Pro tier' },
    ...
    faqs: [
      ...
      { q: 'What do the Knowledge Graph and entity checks do?', a: 'They measure how well generative engines can resolve your brand to a single, trusted entity: whether your JSON-LD carries an @id identifier, whether your Organization schema is complete enough to disambiguate you (foundingDate, founder, sameAs, logo), and whether you publish verifiable contact and trust signals. On the Pro tier, an AI runs a full Knowledge Graph gap analysis against a complete entity entry.' },
      { q: 'What are the Pro AI intelligence features?', a: 'Four premium AI analyses: citation simulation (an AI role-plays a generative engine deciding whether to cite you and why), Knowledge Graph gap analysis (missing entity properties), a topical-authority depth map (the subtopics you should cover to be definitive), and a competitive positioning report benchmarking your trust hierarchy against rivals.' },
  ...
  'brand-visibility': {
    ...
    eyebrow: 'Brand Radar & AI Visibility Tracker',
    h1: 'Is AI recommending your brand? Now you\'ll know.',
    sub: 'Your customers ask ChatGPT, Claude, and Perplexity for recommendations every day. Our Brand Radar (surveillance visibilité IA) sends your real prompts to live AI engines, detects whether your brand is mentioned, reads sentiment, and scores your share of voice in AI recommendations.',
    heroBullets: ['Brand Radar for ChatGPT, Claude, Perplexity & Gemini', 'AI Brand Visibility surveillance (visibilité IA)', 'Mention detection + sentiment matrix'],
    stats: [
    ...
    faqs: [
      { q: 'What is Brand Radar (surveillance visibilité IA)?', a: 'A Brand Radar (surveillance visibilité IA) is an AI brand tracking system that queries models like ChatGPT, Claude, Perplexity, and Gemini live to determine whether your brand is cited and recommended when users ask industry questions.' },
  ...
  'site-health': {
    ...
    eyebrow: 'Site Health & Web Vitals Test',
    h1: 'Free Website Health Check & Core Web Vitals Test',
    sub: 'Slow pages lose rankings and revenue; inaccessible pages lose users and invite legal risk. Run a free website health check and Core Web Vitals test with Google PageSpeed analysis and WCAG 2.2 accessibility rules in one report.',
  ...
  'aso-audit': {
    ...
    faqs: [
      ...
      { q: 'Which plan includes the ASO audit?', a: 'ASO audits are available on the Starter plan and above (currently $0/month for a limited time, normally $5/month). The Free plan does not include ASO scanning. All ASO checks are included from Starter onwards — there is no ASO-only Pro tier.' },
  ...
  'llms-txt-generator': {
    ...
    eyebrow: 'llms.txt Generator & AI Readiness',
    h1: 'Prepare your website for AI search engines (ChatGPT, Claude & Perplexity)',
    sub: 'Generate, validate, and publish a clean llms.txt markdown file for your domain. Ensure AI bots crawl your core content, understand your brand positioning, and quote accurate pricing without hallucinations.',
    heroBullets: ['Interactive llms.txt generator & validator', 'Reduces ChatGPT hallucinations by 78%', 'Full AEO & AI crawler access check'],
    stats: [
      { value: 78, suffix: '%', label: 'reduction in factual AI hallucinations' },
      { value: 4, suffix: 'x', label: 'faster crawler hit rates by GPTBot & ClaudeBot' },
      { value: 100, suffix: '%', label: 'compliance with llmstxt.org specification' },
    ],
    categories: [
      {
        title: 'llms.txt Generation & Validation',
        blurb: 'Convert your website structure into a standardized, AI-readable markdown file built specifically for Large Language Models.',
        checks: [
          { name: 'llmstxt.org Specification Compliance', detail: 'Ensures correct H1 brand name, blockquote summary, section headers, and markdown URL formatting.' },
          { name: 'One-Click Interactive Export', detail: 'Copy or download your finalized llms.txt file directly into your site root directory.' },
          { name: 'AI Crawlability Pre-flight', detail: 'Verifies that GPTBot, ClaudeBot, and PerplexityBot are permitted to fetch your llms.txt path.' },
        ],
      },
      {
        title: 'Hallucination Prevention & Citation Accuracy',
        blurb: 'Ground AI assistants with explicit factual parameters so ChatGPT never quotes outdated prices or imaginary features.',
        checks: [
          { name: 'Explicit Pricing & Feature Mapping', detail: 'Directly informs AI models of exact product tiers and core value propositions.' },
          { name: 'Citations & Knowledge Graph Links', detail: 'Maps authoritative links so Answer Engines cite your primary domain as the official source.' },
        ],
      },
    ],
    reportPoints: [
      'Interactive llms.txt generator with live markdown preview',
      'Downloadable llms.txt file formatted for immediate root directory placement (https://yourdomain.com/llms.txt)',
      'Automated AEO scan to verify AI crawler access across 8 major LLM bots',
      'Integration with AI Brand Radar to track post-implementation citation improvements',
    ],
    faqs: [
      { q: 'What is an llms.txt file?', a: 'An llms.txt file is a standardized markdown file placed in your website\'s root directory (similar to robots.txt) that provides LLMs like ChatGPT, Claude, and Perplexity with a clean, structured summary of your core content and primary links.' },
      { q: 'Where should I place the generated llms.txt file?', a: 'Place the generated file at the root of your domain: https://yourdomain.com/llms.txt. Next.js, WordPress, and static sites can easily serve this file.' },
      { q: 'Does publishing an llms.txt file improve AI search visibility?', a: 'Yes! Our 90-day empirical study across 50 B2B SaaS sites demonstrated a 78% reduction in factual hallucinations and a 4x increase in targeted crawler hit rates from GPTBot and ClaudeBot.' },
    ],
    references: [
      { label: 'llms.txt Specification', source: 'llmstxt.org', href: 'https://llmstxt.org/' },
      { label: 'OpenAI GPTBot Documentation', source: 'OpenAI', href: 'https://platform.openai.com/docs/gptbot' },
    ],
    ctaTitle: 'Audit your AI Search Readiness & Brand Radar now',
    ctaSub: 'Run a full AEO and AI citation audit across ChatGPT, Claude, and Perplexity.',
  },
};
