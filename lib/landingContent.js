 ...
 * across the marketing site. Temporarily set to `false` while the product is
 * being upgraded — flip back to `true` to restore all auth/upgrade buttons.
 */
export const SHOW_AUTH_CTAS = false;
