...
export const FEATURE_PAGES = {
  'security-scanner': {
    ...
    eyebrow: 'Free Website Security Scanner',
    h1: 'Free Website Security Scanner & Vulnerability Assessment Tool',
    sub: 'Run a free online website vulnerability scanner and automated security audit from a single URL. Igris Radar inspects your headers and TLS, hunts for exposed secrets and sensitive files, cross-checks JavaScript libraries against live CVE databases, provides a Subdomain Radar for dangling DNS takeover risks, and generates AI action plans in seconds.',
    ...
    faqs: [
      { q: 'What is a Web Risk Scanner?', a: 'A Web Risk Scanner is an automated security audit tool designed to inspect live web applications for external security risks, OWASP Top 10 vulnerabilities, misconfigured HTTP headers, exposed API secrets, and server data leaks. Igris Radar acts as a complete Web Risk Scanner with severity-ranked findings and AI remediation steps.' },
