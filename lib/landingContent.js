...
export const FEATURE_PAGES = {
  'security-scanner': {
    ...
    eyebrow: 'Web Risk Scanner & Security Audit',
    h1: 'Find the vulnerabilities attackers look for, before they do',
    sub: 'Run a deep Web Risk Scanner and automated security audit from a single URL. Igris Radar inspects your headers and TLS, hunts for exposed secrets and sensitive files, cross-checks JavaScript libraries against live CVE databases, provides a Subdomain Radar for dangling DNS takeover risks, and generates AI action plans in seconds.',
