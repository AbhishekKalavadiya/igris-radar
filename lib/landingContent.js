...
export const FEATURE_PAGES = {
  ...
  'aso-audit': {
    ...
    faqs: [
      ...
      { q: 'Which plan includes the ASO audit?', a: 'ASO audits are available on the Starter plan and above ($5/month). The Free plan does not include ASO scanning. All ASO checks are included from Starter onwards — there is no ASO-only Pro tier.' },
