...
export const FINDING_EXPLANATIONS = {
  ...
  // ─── Security · tier-gated (Starter / Pro) ──────────────────────
  ...
  'Subdomain Takeover & Dangling DNS Radar': "Performs deep automated reconnaissance across 40+ cloud hosting platforms and verifies NXDOMAIN dangling DNS conditions to prevent hostile subdomain takeovers, cookie theft, and brand phishing.",
