...
// white, matching Logo_Dark.png). Read once per process; react-pdf accepts a
// Buffer directly as an Image source.
const DEFAULT_LOGO = readFileSync(join(process.cwd(), 'public', 'logo-dark.png'));
...
function Header({ branding }) {
  ...
  const logoSrc = hasCustomLogo ? branding.logoDataUri : (showDefaultLogo ? DEFAULT_LOGO : null);
