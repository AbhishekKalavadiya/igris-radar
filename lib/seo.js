...
export const SITE_DESCRIPTION =
  'Free AI website audit tool. Run security, SEO, AEO & GEO audits, track brand visibility in AI search, and monitor Core Web Vitals in one platform.'
 ...
 */
export function articleJsonLd({ headline, description, path, datePublished = SITE_PUBLISHED, dateModified, authorName = FOUNDER.name }) {
  return {
    '@context': 'https://schema.org',
    '@type': 'TechArticle',
