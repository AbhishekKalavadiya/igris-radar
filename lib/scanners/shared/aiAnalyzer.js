...
/**
 * SEO deep analysis. Depth scales with plan tier (mirrors the security
 * analyzer): Pro gets the "soft" structural overview; Agency/Enterprise
 * additionally unlock AI Search Intent Mapping and LSI / keyword-gap analysis.
 *
 * @param {string} html
 * @param {string} url
...
Be thorough - this is a paid, in-depth Agency report. Fill lsiKeywordGaps with genuinely relevant Latent Semantic Indexing topics competitors likely cover, not generic filler.`;
    } else {
      prompt += `
}`;
    }
