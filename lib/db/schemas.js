 ...
 * @property {'free'|'starter'|'pro'} plan
 ...
 * @property {BrandingConfig} [branding]  - White-label report branding (Pro; see below)
 ...
 * (lib/server-plans.js) - only Pro (or whatever Admin → Plans
 ...
 * @property {string}  findings.description
 * @property {boolean} findings.passed
 * @property {boolean} [findings.approximate]
 * @property {string}  [findings.remediation]
 * @property {string}  [findings.aiFixPrompt]
 * @property {Object}  [deepAnalysis]
 * @property {Date}    createdAt
