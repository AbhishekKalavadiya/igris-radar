...
const mockFindings = [
  ...
  { id: 'f4', category: 'DNS Security', severity: 'medium', title: 'Threat Modeling Analysis', description: 'desc', passed: false, remediation: 'rem', tier: 'pro' }
];
...
assert(freeResults[3].locked === true, 'Second Pro finding IS locked for free user');
...
assert(proResults[3].locked === undefined, 'Second Pro finding is NOT locked for pro user');
assert(proResults[3].title === 'Threat Modeling Analysis', 'Second Pro finding title is visible for pro user');
